  ...
  <section class="content">
    <div class="container">
      <h2 class="mb-4"><i class="fas fa-file-alt"></i> Materi: Matematika Dasar II</h2>
        ...
        <div class="col-md-8">
          <div class="card">
            ...
            <div class="card-body text-center">
              <iframe width="100%" height="400" src="https://www.youtube.com/embed/iHQSDizFD18" frameborder="0" allowfullscreen></iframe>
            </div>
          </div>
        </div>
            ...
            <div class="card-body">
              <ul class="list-group">
                <li class="list-group-item">
                  ...
                  <a href="ebook1.pdf" target="_blank"> Panduan Matematika Dasar</a>
                </li>
                <li class="list-group-item">
                  <i class="fas fa-file-pdf text-danger"></i> 
                  <a href="ebook2.pdf" target="_blank">Permutasi & Combinasi</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="card mt-4">
        ...
        <div class="card-body">
          <form id="quizForm">
            <div class="mb-3">
              <label>Test: Apa hasil dari 5C3 ?</label>
