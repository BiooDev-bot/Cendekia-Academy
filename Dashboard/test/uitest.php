...
if(isset($_POST["submit"])){
    if($id < 55){
        ...
        if($id<54){
            ...
            $append="INSERT INTO datauser (username, visual, auditori, readwrite, kinestetik) VALUES ('$nama', $A, $B, $C, $D)";
            ...
            mysqli_query( $conn, "UPDATE datalog SET personal = 'yes' WHERE username = '$nama'");
...
<body>
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center">
            <a href="../index3.php" class="btn btn-exit">Keluar</a>
            <h4>Ujian VARK</h4>
